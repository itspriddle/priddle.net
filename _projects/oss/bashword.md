...
`bashword` includes the main [`bin/bashword`](https://github.com/itspriddle/bashword/blob/master/bin/bashword)
bash script and an optional man page
[`share/man/man1/bashword.1`](https://github.com/itspriddle/bashword/blob/master/share/man/man1/bashword.1).
...
[`test/`](https://github.com/itspriddle/bashword/blob/master/test) directory.
...
- This README file
- The [`bin/bashword`](https://github.com/itspriddle/bashword/blob/master/bin/bashword) script's comments at the top of the
  file (shown when `bashword --help` is used)
- The Markdown file at [`doc/man/bashword.1.md`](https://github.com/itspriddle/bashword/blob/master/doc/man/bashword.1.md) that
...
[`doc/man/bashword.1.md`](https://github.com/itspriddle/bashword/blob/master/doc/man/bashword.1.md)
file. The [kramdown-man](https://github.com/postmodern/kramdown-man) Ruby Gem
is used to generate a roff file that `man` uses.
...
MIT License. See [LICENSE](https://github.com/itspriddle/bashword/blob/master/LICENSE)
in this repo.
